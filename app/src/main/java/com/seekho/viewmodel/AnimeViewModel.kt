...
class AnimeViewModel @Inject constructor(private val repository: AnimeDataRepository) :
    ...
    val animeSeries: MutableLiveData<NetworkState<ArrayList<AnimeSeriesList>>?> get() = _animeSeries

    private val _animeDetails = MutableLiveData<NetworkState<AnimeSeriesList>?>()
    val animeDetails: MutableLiveData<NetworkState<AnimeSeriesList>?> get() = _animeDetails
